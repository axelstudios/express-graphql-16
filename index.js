...
function graphqlHTTP(options) {
    ...
    return async function graphqlMiddleware(request, response) {
        ...
        let graphiqlOptions;
        let formatErrorFn = (error) => new graphql_1.GraphQLError(error.message, error.nodes, error.source, error.positions, error.path, error.originalError, error.extensions);
        let pretty = false;
        let result;
        try {
            ...
            try {
                ...
                formatErrorFn =
                    (_c = (_b = optionsData.customFormatErrorFn) !== null && _b !== void 0 ? _b : optionsData.formatError) !== null && _c !== void 0 ? _c : formatErrorFn;
                throw error;
            }
            ...
            formatErrorFn =
                (_m = (_l = optionsData.customFormatErrorFn) !== null && _l !== void 0 ? _l : optionsData.formatError) !== null && _m !== void 0 ? _m : formatErrorFn;
            devAssertIsObject(schema, 'GraphQL middleware options must contain a schema.');
            // GraphQL HTTP only supports GET and POST methods.
            if (request.method !== 'GET' && request.method !== 'POST') {
                throw (0, http_errors_1.default)(405, 'GraphQL only supports GET and POST requests.', {
            ...
            if (query == null) {
                ...
                throw (0, http_errors_1.default)(400, 'Must provide query string.');
            }
            // Validate Schema
            const schemaValidationErrors = (0, graphql_1.validateSchema)(schema);
            if (schemaValidationErrors.length > 0) {
                // Return 500: Internal Server Error if invalid schema.
                throw (0, http_errors_1.default)(500, 'GraphQL schema validation error.', {
            ...
            try {
                ...
                throw (0, http_errors_1.default)(400, 'GraphQL syntax error.', {
            ...
            if (validationErrors.length > 0) {
                ...
                throw (0, http_errors_1.default)(400, 'GraphQL validation error.', {
            ...
            if (request.method === 'GET') {
                ...
                if (operationAST && operationAST.operation !== 'query') {
                    ...
                    throw (0, http_errors_1.default)(405, `Can only perform a ${operationAST.operation} operation from a POST request.`, { headers: { Allow: 'POST' } });
                }
            }
            ...
            try {
                ...
                throw (0, http_errors_1.default)(400, 'GraphQL execution context error.', {
            ...
            const error = (0, http_errors_1.default)(500, 
...
function respondWithGraphiQL(response, options, params, result) {
    ...
    const payload = (0, renderGraphiQL_1.renderGraphiQL)(data, options);
...
async function getGraphQLParams(request) {
    ...
    const bodyData = await (0, parseBody_1.parseBody)(request);
    ...
    if (typeof variables === 'string') {
        try {
            ...
            throw (0, http_errors_1.default)(400, 'Variables are invalid JSON.');
        }
    }
...
function canDisplayGraphiQL(request, params) {
    ...
    return !params.raw && (0, accepts_1.default)(request).types(['json', 'html']) === 'html';
}
/**
