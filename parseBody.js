...
async function parseBody(req) {
    ...
    switch (typeInfo.type) {
        ...
        case 'application/json':
            ...
            throw (0, http_errors_1.default)(400, 'POST body sent invalid JSON.');
...
async function readBody(req, typeInfo) {
    ...
    if (charset !== 'utf8' && charset !== 'utf-8' && charset !== 'utf16le') {
        throw (0, http_errors_1.default)(415, `Unsupported charset "${charset.toUpperCase()}".`);
    }
    ...
    try {
        ...
        if (rawError instanceof get_stream_1.MaxBufferError) {
            throw (0, http_errors_1.default)(413, 'Invalid body: request entity too large.');
        }
        else {
            const message = rawError instanceof Error ? rawError.message : String(rawError);
            throw (0, http_errors_1.default)(400, `Invalid body: ${message}.`);
        }
    }
}
